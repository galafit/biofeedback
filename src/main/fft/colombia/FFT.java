...
public class FFT {
  ...
  // Lookup tables.  Only need to recompute when size of Fourie changes.
  double[] cos;
  double[] sin;
  ...
  public FFT(int n) {
    ...
    if(n != (1<<m))
      throw new RuntimeException("Fourie length must be power of 2");
...
//     }
  ...
  ****************************************************************/
  ...
  // Test the Fourie to make sure it's working
